    ...
    <section className="relative overflow-hidden bg-[#141418] py-[110px]">
      ...
      <ViewUp className="site-container relative z-[2] text-center" range="entry 0% cover 40%">
        <div className="mb-[18px] flex items-center justify-center gap-[9px]">
          <TriangleIcon fill="#5a5af5" />
          <span className="text-[13px] font-extrabold tracking-[.18em] text-[#a9aefc] uppercase">İletişim</span>
        </div>
        ...
        <div className="mt-[26px] flex flex-wrap items-center justify-center gap-x-9 gap-y-[18px]">
          <a
            ...
            className="border-b-2 border-[rgba(122,124,255,.4)] pb-[3px] text-[16px] font-extrabold text-white no-underline transition-colors hover:border-[#7a7cff]"
          >
            {contact.phone}
          </a>
          <a
        ...
        <MagneticLink
          href="/iletisim"
          className="mt-10 rounded-xl bg-brand-blue px-[42px] py-[17px] text-[15.5px] font-extrabold text-white hover:bg-brand-blue-dark hover:shadow-[0_20px_48px_rgba(38,38,188,.5)]"
        >
          İletişime Geçin
        </MagneticLink>
      </ViewUp>
